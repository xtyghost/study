/**
 * Copyright (C), 2015-2020, XXX有限公司 FileName: MvcResponseBodyAdvice Author: xutong Date: 2020/8/6
 * 9:19 上午 Description: 对response请求进行后置处理 History: <author> <time> <version> <desc> 作者姓名 修改时间 版本号 描述
 */
package com.example.study.mvc.intercepter;
...
public class MvcResponseBodyAdvice implements ResponseBodyAdvice, RequestBodyAdvice {
  ...
  class CustomHttpInputMessage implements HttpInputMessage {
    ...
    public InputStream getBody() throws IOException {
      ...
      return IOUtils.toInputStream(
          JSON.toJSONString(parse, SerializerFeature.WriteMapNullValue), "UTF-8");
    }
